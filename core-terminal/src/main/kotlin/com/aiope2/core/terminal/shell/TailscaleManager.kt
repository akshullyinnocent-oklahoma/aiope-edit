...
object TailscaleManager {
  ...
  fun install(ctx: Context): String = try {
  ...
  fun startDaemon(ctx: Context): String = try {
  ...
  /** Login to Tailscale */
  fun login(ctx: Context, authKey: String = ""): String = try {
  ...
  fun logout(ctx: Context): String = try {
  ...
  /** Stop tailscaled */
  fun stop(ctx: Context): String = try {
  ...
  fun advertiseExitNode(ctx: Context): String = try {
  ...
  /** Use an exit node */
  fun useExitNode(ctx: Context, nodeIp: String): String = try {
  ...
  fun enableSSH(ctx: Context): String = try {
